...
import net.mcreator.kitchensink.gui.CrateguiGui;
...
public class CrateBlock extends KitchenSinkModElements.ModElement {
	@ObjectHolder("kitchen_sink:crate")
	public static final Block block = null;
	@ObjectHolder("kitchen_sink:crate")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public CrateBlock(KitchenSinkModElements instance) {
		super(instance, 66);
