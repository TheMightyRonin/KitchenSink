...
import net.mcreator.kitchensink.item.CopperIngotItem;
...
public class CopperOreBlock extends KitchenSinkModElements.ModElement {
	@ObjectHolder("kitchen_sink:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(KitchenSinkModElements instance) {
		super(instance, 27);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 11)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(19, 1, 1, 70))));
		}
	}
}
