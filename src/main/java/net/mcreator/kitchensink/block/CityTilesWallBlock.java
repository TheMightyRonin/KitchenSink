...
import net.mcreator.kitchensink.procedures.CitytilewallonbreakProcedure;
...
public class CityTilesWallBlock extends KitchenSinkModElements.ModElement {
	@ObjectHolder("kitchen_sink:city_tiles_wall")
	public static final Block block = null;
	public CityTilesWallBlock(KitchenSinkModElements instance) {
		super(instance, 128);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("city_tiles_wall");
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				CitytilewallonbreakProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
