...
public class CopperBlockBlock extends KitchenSinkModElements.ModElement {
	@ObjectHolder("kitchen_sink:copper_block")
	public static final Block block = null;
	public CopperBlockBlock(KitchenSinkModElements instance) {
		super(instance, 28);
	}
