...
import net.mcreator.kitchensink.procedures.RangerKnightEntityIsHurtProcedure;
import net.mcreator.kitchensink.procedures.RangerKnightEntityDiesProcedure;
...
public class RangerKnightEntity extends KitchenSinkModElements.ModElement {
	public static EntityType entity = null;
	public RangerKnightEntity(KitchenSinkModElements instance) {
		super(instance, 100);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(500).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("ranger_knight")
						.setRegistryName("ranger_knight");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("ranger_knight_spawn_egg"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelrangerknight(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("kitchen_sink:textures/rangerknight.png");
				}
			};
		});
	}
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(3, new AvoidEntityGoal(this, ServerPlayerEntity.class, (float) 6, 1, 1.2));
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				RangerKnightEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("world", world);
				RangerKnightEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			VoidBlastItem.shoot(this, target);
		}
