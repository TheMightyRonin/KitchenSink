...
import net.mcreator.kitchensink.procedures.VoidBlastRangedItemUsedProcedure;
...
public class VoidBlastItem extends KitchenSinkModElements.ModElement {
	@ObjectHolder("kitchen_sink:void_blast")
	public static final Item block = null;
	@ObjectHolder("kitchen_sink:entitybulletvoid_blast")
	public static final EntityType arrow = null;
	public VoidBlastItem(KitchenSinkModElements instance) {
		super(instance, 102);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletvoid_blast").setRegistryName("entitybulletvoid_blast"));
	}
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 3f, 2, 1);
					...
					entityarrow.pickupStatus = AbstractArrowEntity.PickupStatus.DISALLOWED;
					{
						...
						VoidBlastRangedItemUsedProcedure.executeProcedure($_dependencies);
					}
				}
			}
		}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("kitchen_sink:textures/voidblast.png");
		...
		public void render(ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn,
			...
			EntityModel model = new Modelvoidblast();
	...
	public static class Modelvoidblast extends EntityModel<Entity> {
		private final ModelRenderer bb_main;
		public Modelvoidblast() {
			textureWidth = 32;
			textureHeight = 32;
			bb_main = new ModelRenderer(this);
			bb_main.setRotationPoint(0.0F, 24.0F, 0.0F);
			bb_main.setTextureOffset(0, 0).addBox(-4.0F, -16.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.0F, false);
		}
